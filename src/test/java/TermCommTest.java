...
//        System.out.println(StringEscapeUtils.escapeJava(outContent.toString()));
    ...
    public void askTest() {
        ...
        assert comm.ask("question", false ).equals("answer");
    ...
    public void askYesNoTest() {
        ...
        Communicator comm = new TermComm(inContent, outContent, System.err);
        assert comm.confirm("question",null, false);
    ...
    public void setTest() {
        ...
        Communicator comm = new TermComm(inContent, outContent, System.err);
        assert comm.set("question",Integer::parseInt,null, false ).equals(12);
        assert outContent.toString().strip().equals("question");
    }
    ...
    public void chooseTest() {
        ...
        Integer option = comm.choose("question", Map.of(
                "option1", 1,
                "option2", 2
        ), List.of("option1","option2"),null, false);
        assert option == 1;
